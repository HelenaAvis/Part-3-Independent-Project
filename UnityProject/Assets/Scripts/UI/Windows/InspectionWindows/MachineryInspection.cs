...
public class MachineryInspection : MonoBehaviour
{
    ...
    public void Initialise()
    {
        ...
        IndustrialMachinery machinery = (IndustrialMachinery)asset;
        if (!machinery.functioning)
        {
            statusText.GetComponent<TextMeshProUGUI>().text = "Machinery Status: Disabled";
        }
        else
        {
            statusText.GetComponent<TextMeshProUGUI>().text = "Machinery Status: Functioning";
        }
    }
}
